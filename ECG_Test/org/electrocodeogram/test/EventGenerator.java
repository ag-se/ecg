...
public class EventGenerator
{
    ...
    public EventGenerator() throws IOException
    {
        ...
        File file = new File(
                ".." + File.separator + "ECG_Test" + File.separator + this.filename);
    ...
    private List createArgList(boolean argListNotNull, boolean argListOfString, int argListLength, int argListEntrySize) throws NoTestDataException
    {
        if (!argListNotNull) {
            return null;
        }
     ...
     * @throws NoTestDataException If a pseudorandom String is requested by a line number that is not available or if the requested String size is to higher then available 
     */
    private String[] createPayloadStringArray(int arraySize, int stringSize) throws NoTestDataException
    {
