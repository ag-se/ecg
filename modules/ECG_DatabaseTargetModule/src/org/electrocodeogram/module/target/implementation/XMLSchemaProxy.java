...
public class XMLSchemaProxy {
    ...
    /**
     * the DBCommunicator which directly communicates with the database
     */
    ...
    private void mapElementsToDB(SchemaType schemaType, Table table,
        ...
        for (int i = 0; i < properties.length; i++) {
            ...
            if (currentSchemaType.isSimpleType()) {
                 ...
                 * only this element is created the name of the table consists
                 * of the name of the father element, then an underline followed
                 * by the name of the current explored element
                 */
                switch (currentSchemaType.getSimpleVariety()) {
                     ...
                     * stored in the database as a single column with the item
                     * data in the rows as BLOBs
                     */
                ...
                switch (currentSchemaType.getContentType()) {
                    ...
                    case org.apache.xmlbeans.SchemaType.EMPTY_CONTENT:
                        ...
                        Table emptyTable = new Table(this.coreSchemaName + "_"
                                + currentElementName + "_attributes",
                                new Vector<ColumnElement>());
    ...
    private void maxOccursTable(String currentElementName,
            String fatherElementName, SchemaType currentSchemaType) {
        Table maxOccursTable = new Table(this.coreSchemaName + "_"
                + fatherElementName + "_maxOccurs_" + currentElementName,
                new Vector<ColumnElement>());
        ColumnElement tableColumn = null;
        switch (currentSchemaType.getSimpleVariety()) {
            case org.apache.xmlbeans.SchemaType.ATOMIC:
