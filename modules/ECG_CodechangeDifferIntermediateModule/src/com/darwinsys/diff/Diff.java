...
import org.electrocodeogram.module.intermediate.implementation.Delta;
import org.electrocodeogram.module.intermediate.implementation.CodechangeDifferIntermediateModule.DeltaType;
...
class fileInfo {
    ...
    fileInfo(String filename) {
        ...
        file = new BufferedReader(new StringReader(filename));
        //        } catch (IOException e) {
...
public class Diff {
    ...
    void printout() {
        ...
        DeltaType type = DeltaType.NOCHANGE;
        ...
        for (printoldline = printnewline = 1;;) {
            ...
            if (newinfo.other[printnewline] < 0) {
                ...
                if (oldinfo.other[printoldline] < 0) {
                    ...
                    linenumber = printoldline;

                    from = oldinfo.symbol[printoldline].showSymbol();
                ...
                } else
                {
                    if (printstatus == change) {
                        ...
                        to = newinfo.symbol[printnewline].showSymbol();
                        
                        Delta delta = new Delta(new String(from), printoldline, new String(to), type);
                        ...
                        to = oldinfo.symbol[printoldline].showSymbol();
    ...
    void showinsert() {
        if (printstatus == change) {
            ...
            this.to = newinfo.symbol[printnewline].showSymbol();
    ...
    void showchange() {
        ...
        printstatus = change;
        String line = oldinfo.symbol[printoldline].showSymbol();
