    ...
    public EventWindow() {
        ...
        this._menuSent.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                EventWindow.this._guiWriter
                    .set_deliveryState(DELIVERY_STATE.SENT);
        ...
        this._menuReceived.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                EventWindow.this._guiWriter
                    .set_deliveryState(DELIVERY_STATE.RECEIVED);
        ...
        this._scrollPane.getVerticalScrollBar().getModel().addChangeListener(
            new ChangeListener() {

                public void stateChanged(ChangeEvent e) {
                    if (EventWindow.this._autoscroll) {
                        JScrollBar vertBar = EventWindow.this._scrollPane
    ...
    public void setSelectedModul(int moduleId) {
        try {
            ...
            if (moduleId == -1) {
                ...
                if (this._guiWriter.get_deliveryState().equals(
                    DELIVERY_STATE.SENT)) {

                    this._titledBorder
                        .setTitle(MODULE_SELECTED_AND_SENT
                                  + org.electrocodeogram.system.System
                                      .getInstance().getModuleRegistry()
                                      .getModule(moduleId).getName());

                } else {
                    this._titledBorder
                        .setTitle(MODULE_SELECTED_AND_RECEIVED
                                  + org.electrocodeogram.system.System
                                      .getInstance().getModuleRegistry()
                                      .getModule(moduleId).getName());
                }
            ...
            JOptionPane.showMessageDialog(org.electrocodeogram.system.System
                .getInstance().getMainWindow(), e.getMessage(),
                "Module Selection", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private static class GuiWriter {
        ...
        public void write(ValidEventPacket eventPacket) {
            if (this._target != null) {
                if (eventPacket.getSourceId() == ModuleGraph
                    .getSelectedModule()) {
                    if (eventPacket.getDeliveryState() != null) {
                        if (eventPacket.getDeliveryState().equals(
                            this._deliveryState)) {
                            this._target.append(eventPacket.getTimeStamp()
                                .toString()
                                                + ","
                                                + eventPacket
                                                    .getSensorDataType());
                            ...
                            if (argList != null) {
                                ...
                                Object[] args = eventPacket.getArgList()
                                    .toArray();
