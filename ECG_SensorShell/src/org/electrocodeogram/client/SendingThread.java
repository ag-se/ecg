...
public class SendingThread extends Thread
{
     ...
     */
    protected static SendingThread theInstance = null;
    ...
    private void connectToServer()
    {
        ...
        try {
            ...
            this._logger.log(Level.INFO, "Connected to the ECG Server at " + this.$host.toString() + ":" + this.$port);
        }
        catch (IOException e) {

            this._logger.log(Level.WARNING, "Unable to connect to the ECG Server at " + this.$host.toString() + ":" + this.$port + " \nNext attempt in " + this.connectionDelay / 1000 + " seconds.");
    ...
    public void run()
    {
        ...
        while (this.runningFlag) {
            ...
            while (this.queue.getSize() > 0) {
            	...
            	this._logger.log(Level.ALL,"loop");
                ...
                try {
                    ...
                    this._logger.log(Level.ALL,"get packet");
                    
                    // send packet serialized over socket
                    this.oos.writeObject(packet);
                    
                    this._logger.log(Level.ALL,"object written");
                    ...
                    if(count >= 100)
                    {
                    	...
                    	this._logger.log(Level.INFO,"Stream reset");
                    }
                    ...
                    this._logger.log(Level.WARNING, "Lost connection to the ECG Server.");
