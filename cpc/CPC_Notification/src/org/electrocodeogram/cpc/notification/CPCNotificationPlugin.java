package org.electrocodeogram.cpc.notification;
 ...
 */
public class CPCNotificationPlugin extends AbstractUIPlugin
{
	private static Log log = LogFactory.getLog(CPCNotificationPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.notification";

	// The shared instance
	private static CPCNotificationPlugin plugin;
	 ...
	 */
	public static CPCNotificationPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCNotificationPlugin.class.getName());
	//		log.info("using shared logging");
