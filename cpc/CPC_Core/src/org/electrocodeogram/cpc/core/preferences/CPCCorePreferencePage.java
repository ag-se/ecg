...
public class CPCCorePreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{

	public CPCCorePreferencePage()
	{
		super(GRID);
		setPreferenceStore(CPCCorePlugin.getDefault().getPreferenceStore());
		setDescription(Messages.CPCCorePreferencePage_title);
	}
	...
	{
		addField(new BooleanFieldEditor(CPCPreferenceConstants.PREF_DEBUG_MODE_ENABLED,
				Messages.CPCCorePreferencePage_option_debugChecking, getFieldEditorParent()));
