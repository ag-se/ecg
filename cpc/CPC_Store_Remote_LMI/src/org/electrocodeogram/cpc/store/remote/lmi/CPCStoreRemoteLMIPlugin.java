package org.electrocodeogram.cpc.store.remote.lmi;
 ...
 */
public class CPCStoreRemoteLMIPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCStoreRemoteLMIPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.store.remote.lmi";

	// The shared instance
	private static CPCStoreRemoteLMIPlugin plugin;
	 ...
	 * The constructor
	 */
	public CPCStoreRemoteLMIPlugin()
	{
		plugin = this;
		...
		log.trace("registered repository providers:");
		if (Platform.isRunning())
			for (String provider : RepositoryProvider.getAllProviderTypeIds())
				log.trace("RepositoryProvider: " + provider);
	}
	 ...
	 */
	public static CPCStoreRemoteLMIPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCStoreRemoteLMIPlugin.class.getName());
	//		log.info("using shared logging");
