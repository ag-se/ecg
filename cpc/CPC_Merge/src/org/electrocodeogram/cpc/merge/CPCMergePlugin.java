package org.electrocodeogram.cpc.merge;
 ...
 */
public class CPCMergePlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCMergePlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.merge";

	// The shared instance
	private static CPCMergePlugin plugin;
	 ...
	 */
	public static CPCMergePlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCMergePlugin.class.getName());
	//		log.info("using shared logging");
