package org.electrocodeogram.cpc.exports.ui;
 ...
 */
public class CPCExportsUIPlugin extends AbstractUIPlugin
{
	private static Log log = LogFactory.getLog(CPCExportsUIPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.exports.ui";

	// The shared instance
	private static CPCExportsUIPlugin plugin;
	 ...
	 */
	public static CPCExportsUIPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCExportsUIPlugin.class.getName());
	//		log.info("using shared logging");
