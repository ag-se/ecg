package org.electrocodeogram.cpc.store.local.sql;
 ...
 */
public class CPCStoreLocalSQLPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCStoreLocalSQLPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.store.local.sql";

	// The shared instance
	private static CPCStoreLocalSQLPlugin plugin;
	 ...
	 */
	public static CPCStoreLocalSQLPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCStoreLocalSQLPlugin.class.getName());
	//		log.info("using shared logging");
