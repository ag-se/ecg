package org.electrocodeogram.cpc.store;
 ...
 */
public class CPCStorePlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCStorePlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.store";

	// The shared instance
	private static CPCStorePlugin plugin;
	 ...
	 */
	public static CPCStorePlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCStorePlugin.class.getName());
	//		log.info("using shared logging");
