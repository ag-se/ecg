package org.electrocodeogram.cpc.debug;
 ...
 */
public class CPCDebugPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCDebugPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.debug";

	// The shared instance
	private static CPCDebugPlugin plugin;
	 ...
	 */
	public static CPCDebugPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCDebugPlugin.class.getName());
	//		log.info("using shared logging");
