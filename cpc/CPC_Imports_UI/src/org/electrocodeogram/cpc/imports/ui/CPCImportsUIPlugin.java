package org.electrocodeogram.cpc.imports.ui;
 ...
 */
public class CPCImportsUIPlugin extends AbstractUIPlugin
{
	private static Log log = LogFactory.getLog(CPCImportsUIPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.imports.ui";

	// The shared instance
	private static CPCImportsUIPlugin plugin;
	 ...
	 */
	public static CPCImportsUIPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCImportsUIPlugin.class.getName());
	//		log.info("using shared logging");
