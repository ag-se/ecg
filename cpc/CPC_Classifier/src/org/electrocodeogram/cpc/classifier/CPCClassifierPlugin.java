package org.electrocodeogram.cpc.classifier;
 ...
 */
public class CPCClassifierPlugin extends AbstractUIPlugin
{
	private static Log log = LogFactory.getLog(CPCClassifierPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.classifier";

	// The shared instance
	private static CPCClassifierPlugin plugin;
	 ...
	 */
	public static CPCClassifierPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCClassifierPlugin.class.getName());
	//		log.info("using shared logging");
