 ...
 * @author marco kranz
 */
public class ReplayElement implements Comparable<ReplayElement>
{
	 ...
	 */
	public ReplayElement(Date ts, int ordinal, String[] path, String change, String name, String identifier,
			String source)
	{
		this.timestamp = ts;
	...
	public String toString()
	{
		...
		return "Replay Element: Name: " + name + " Path: " + p + " Change: " + exact_change + " Timestamp: "
				+ timestamp + " (Ordinal:" + ordinal + ") Identifier: " + identifier + " Source: " + source + " "
				+ diff;
	}

	public int compareTo(ReplayElement o)
	{
