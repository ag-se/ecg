package org.electrocodeogram.cpc.exports.mp;
 ...
 */
public class CPCExportsMPPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCExportsMPPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.exports.mp";

	// The shared instance
	private static CPCExportsMPPlugin plugin;
	 ...
	 */
	public static CPCExportsMPPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCExportsMPPlugin.class.getName());
	//		log.info("using shared logging");
	//
	// standalone logger
	/*
