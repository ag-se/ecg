...
/**
 * PluginLogManager This class encapsulates a Log4J Hierarchy and centralizes
 * all Logger access.
 * 
 * @author Manoel Marques
 */
public class PluginLogManager implements ILogManager
{
	 ...
	 * the list of active plug-in log managers.
	 * 
	 * @param plugin
	 *            the plug-in object
	 * @param properties
	 ...
	 * the Eclipse log API, it will be channelled to this logging framework.
	 * 
	 * @param id
	 ...
	 * be channelled to this logging framework anymore.
	 * 
	 * @param id
	 *            logger name (usually the the plug-in id)
	 */
	...
	{
		internalShutdown();
		ECGEclipseCorePlugin.getDefault().getPluginLogRegistry().removeLogManager(this);
	}
