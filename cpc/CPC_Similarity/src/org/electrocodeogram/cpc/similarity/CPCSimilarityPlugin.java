package org.electrocodeogram.cpc.similarity;
 ...
 */
public class CPCSimilarityPlugin extends AbstractUIPlugin
{
	private static Log log = LogFactory.getLog(CPCSimilarityPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.similarity";

	// The shared instance
	private static CPCSimilarityPlugin plugin;
	 ...
	 */
	public static CPCSimilarityPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCSimilarityPlugin.class.getName());
	//		log.info("using shared logging");
