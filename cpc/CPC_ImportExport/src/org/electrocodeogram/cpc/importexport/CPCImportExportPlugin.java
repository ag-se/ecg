package org.electrocodeogram.cpc.importexport;
 ...
 */
public class CPCImportExportPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCImportExportPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.importexport";

	// The shared instance
	private static CPCImportExportPlugin plugin;
	 ...
	 */
	public static CPCImportExportPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCImportExportPlugin.class.getName());
	//		log.info("using shared logging");
