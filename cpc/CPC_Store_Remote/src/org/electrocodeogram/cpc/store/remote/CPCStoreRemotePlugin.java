package org.electrocodeogram.cpc.store.remote;
 ...
 */
public class CPCStoreRemotePlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCStoreRemotePlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.store.remote";

	// The shared instance
	private static CPCStoreRemotePlugin plugin;
	 ...
	 */
	public static CPCStoreRemotePlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCStoreRemotePlugin.class.getName());
	//		log.info("using shared logging");
