package org.electrocodeogram.cpc.store.local.xml;
 ...
 */
public class CPCStoreLocalXMLPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCStoreLocalXMLPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.store.local.xml";

	// The shared instance
	private static CPCStoreLocalXMLPlugin plugin;
	 ...
	 */
	public static CPCStoreLocalXMLPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCStoreLocalXMLPlugin.class.getName());
	//		log.info("using shared logging");
