package org.electrocodeogram.cpc.optimiser;
 ...
 */
public class CPCOptimiserPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCOptimiserPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.optimiser";

	// The shared instance
	private static CPCOptimiserPlugin plugin;
	 ...
	 */
	public static CPCOptimiserPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCOptimiserPlugin.class.getName());
	//		log.info("using shared logging");
