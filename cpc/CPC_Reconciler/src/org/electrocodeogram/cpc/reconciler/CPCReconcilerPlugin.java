package org.electrocodeogram.cpc.reconciler;
 ...
 */
public class CPCReconcilerPlugin extends Plugin
{
	private static Log log = LogFactory.getLog(CPCReconcilerPlugin.class);

	// The plug-in ID
	public static final String PLUGIN_ID = "org.electrocodeogram.cpc.reconciler";

	// The shared instance
	private static CPCReconcilerPlugin plugin;
	 ...
	 */
	public static CPCReconcilerPlugin getDefault()
	{
		return plugin;
	}
	...
	//		log = this.logManager.getLogger(CPCReconcilerPlugin.class.getName());
	//		log.info("using shared logging");
