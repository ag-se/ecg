...
public final class UIConstants {
    ...
    public static final Color ECG_BLUE = new Color(77, 175, 229);

    public static final Color ECG_DARK_BLUE = new Color(10, 0, 130);

    public static final Color ECG_LIGHT_BLUE = new Color(247, 250, 255);

    public static final Color ECG_LIGHT_GREEN = new Color(240, 255, 255);

    public static final Color ECG_DARK_GREEN = new Color(127, 243, 63);

    public static final Color ECG_SEPIA = new Color(255, 204, 153);

    public static final Color ECG_LIGHT_SEPIA = new Color(255, 237, 210);

    public static final Color ECG_GOLD = new Color(253, 212, 61);

    public static final Color ECG_RED = new Color(255, 63, 63);

    public static final int MEDIUM_BORDER_WIDTH = 2;

    public static final int SMALL_BORDER_WIDTH = 1;

    public static final boolean BORDER_ROUNDED = true;
