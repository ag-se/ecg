...
public abstract class IntermediateModule extends Module implements IIntermediateModule
{
     ...
     */
    public IntermediateModule(IntermediateModule.ProcessingMode processingMode, IntermediateModule.AnnotationStyle annotationStyle, String separator)
    {
     ...
     * @param separator Sets the separator string to the given value
     */
    public IntermediateModule(IntermediateModule.AnnotationStyle annotationStyle, String separator)
    {
        super(ModuleType.INTERMEDIATE_MODULE);
     ...
     * @param processingMode Sets the processing mode of the module 
     */
    public IntermediateModule(IntermediateModule.ProcessingMode processingMode)
    {
        super(ModuleType.INTERMEDIATE_MODULE);
