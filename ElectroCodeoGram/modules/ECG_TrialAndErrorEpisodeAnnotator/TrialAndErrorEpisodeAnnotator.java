 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TrialAndErrorEpisodeAnnotator extends EventProcessor
{
    
    private int state = 1;
    
    public TrialAndErrorEpisodeAnnotator()
    {
        super(EventProcessor.POST_ANNOTATION,":\n","TrialAndErrorEpisodeAnnotator");
    ...
    public EventPacket annotate(EventPacket e)
    {
        ...
        logger.log(Level.INFO,"annotate");
        ...
        if(state == 1)
        {
            ...
            if(isPacketMatching(e,"Activity","Run"))
            {
